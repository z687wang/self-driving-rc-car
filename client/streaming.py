...
ap.add_argument("--host", required=False, help="Raspberry Pi hostname or IP")
args = vars(ap.parse_args())
#host = args["host"]
host = "192.168.5.66:8090"
...
stream = urllib.request.urlopen('http://{host}/test.mjpg`'.format(host=host))
